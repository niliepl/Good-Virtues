...
Public Class Form5
    ...
    Private Sub Pic_NextExercise_Click(sender As Object, e As EventArgs) Handles Pic_NextExercise.Click
        Form6.Show()
        Me.Hide()
    End Sub
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        Dim youtubeUrl As String = "https://youtu.be/WDIpL0pjun0?feature=shared"
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        Dim youtubeUrl As String = "https://youtu.be/xrPteyQLGAo?feature=shared"
        Dim psi As New ProcessStartInfo
        psi.UseShellExecute = True
        psi.FileName = youtubeUrl
        Process.Start(psi)
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        Dim youtubeUrl As String = "https://youtu.be/B296mZDhrP4?feature=shared"
        Dim psi As New ProcessStartInfo
        psi.UseShellExecute = True
        psi.FileName = youtubeUrl
        Process.Start(psi)
